...
void initializeRooms(){
    planRooms.push_back(Rooms("A1;LEC;EX"));
    planRooms.push_back(Rooms("A2;LEC;EX"));
    planRooms.push_back(Rooms("A3;LEC;EX"));
    planRooms.push_back(Rooms("A4;LEC;EX"));
...
int main() {
    initializeData();
    Plan mainPlan(planRooms,definedHours,planInstructors,planSubjects,weekDays,planGroups);
    mainPlan.showPlan();
